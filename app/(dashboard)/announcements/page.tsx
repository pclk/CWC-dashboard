...
export default async function AnnouncementsPage() {
  ...
  const { templateMap } = await getSettingsAndTemplates(userId);
    ...
    <div className="space-y-4">
      <section className="rounded-[2rem] border border-black/10 bg-white/90 p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">
          These messages are convenience generators. Values persist locally in the browser for quick reuse.
        </p>
      </section>

      <div className="grid gap-4 xl:grid-cols-3">
        <AnnouncementPreview
          storageKey="announcement-mtr-1030"
          title="MTR 1030"
          mode="mtr"
        ...
        />
        <AnnouncementPreview
          storageKey="announcement-mtr-1630"
          title="MTR 1630"
          mode="mtr"
        ...
        />
        <AnnouncementPreview
          storageKey="announcement-last-parade-1730"
